// Adapted from here: https://github.com/Tesollo-Delto/DELTO_B_ROS2/blob/93e332cf3ff009a3a593b8054308ebe253460325/delto_3f_driver/include/delto_external_TCP.hpp
#pragma once 
#include <iostream>
#include <vector>
#include <cmath>
...
namespace Tesollo 
{
    ...
    {
    public:
        TesolloCommunication(const std::string& ip, int port);
