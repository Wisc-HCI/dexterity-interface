...
# from relaxed_ik_ros2.msg import EEPoseGoals, EEVelGoals # not using here
from ament_index_python.packages import get_package_share_directory

path_to_src = get_package_share_directory('robot_motion') + '/ik/'
...
class RvizViewer(Node):
    def __init__(self):
        ...
        default_setting_file_path = path_to_src + 'settings.yaml'
