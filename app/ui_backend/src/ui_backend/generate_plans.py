...
TASKS = [
    ...
    "Pick the red cube, then pick the green cube, then pick the blue cube, then move the red cube, then move the green cube.",
    "Pick the red cube, then pick the blue cube, then move the red cube, then move the blue cube, then move the red cube left.",
    "Pick the green cube, then pick the blue cube, then move the green cube, then move the blue cube, then move the green cube left.",
    "Pick the red cube, then pick the green cube, then move the red cube, then move the red cube left, then move the green cube left.",
    "Pick the blue cube, then pick the red cube, then move the blue cube, then move the blue cube left, then move the red cube left.",
    "Pick the green cube, then pick the blue cube, then pick the red cube, then move the blue cube left, then move the green cube left.",
    "Pick the red cube, then pick the green cube, then pick the blue cube, then move the blue cube left, then move the red cube left.",
    "Pick the blue cube, then move the blue cube, then move the green cube, then move the blue cube left, then move the green cube left.",
    "Pick the green cube, then pick the red cube, then move the green cube, then move the red cube left, then move the green cube left.",
]
